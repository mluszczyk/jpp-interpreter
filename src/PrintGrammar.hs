...
instance Print Exp where
  prt i e = case e of
    ...
    ELTE exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "<="), prt 2 exp2])
    EGT exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString ">"), prt 2 exp2])
    EGTE exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString ">="), prt 2 exp2])
    EEq exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "=="), prt 2 exp2])
    ENEq exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "/="), prt 2 exp2])
    ...
    EDiv exp1 exp2 -> prPrec i 3 (concatD [prt 3 exp1, doc (showString "`div`"), prt 4 exp2])
